"""Shared helpers for the real-time (particle-filter) figures.

The delays paper's real-time figures run the SSE and SSI onset-anchored particle
filters over an observed weekly onset history and Bayesian-average them; this
module holds that shared binning / model-averaging / ensemble logic.
"""
