"""Figure 1: onset-anchored PMO vs r (weeks without onsets since index onset).
...
Loads pre-computed results from results/fig1_pmo_vs_r_delay.csv (run
...
def main() -> None:
    ...
    df = pd.read_csv(RESULTS_DIR / "fig1_pmo_vs_r_delay.csv")
    ...
    save(fig, "fig1_pmo_vs_r_delay", OUT_DIR)
