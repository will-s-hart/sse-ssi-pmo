"""Compute and save results for Figure 6: real-time PMO, 2020 Equateur outbreak.
...
def main() -> None:
    ...
    raw = pd.read_csv(DATA_DIR / FIG6_DATA_FILE)
    ...
    out_path = RESULTS_DIR / "fig6_pmo_realtime_equateur2020.csv"
