"""Compute and save results for Figure 12: onset-anchored PMO across histories.
...
R0: float = DEFAULT_R0
K: float = DEFAULT_K
HISTORIES: list[list[int]] = FIG12_HISTORIES
...
def main() -> None:
    ...
    out_path = RESULTS_DIR / "fig12_pmo_comparison_delay.csv"
    df = pd.DataFrame(
        {
