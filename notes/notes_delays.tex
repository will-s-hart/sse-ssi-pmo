...
day~$t$, with the incubation period of \S\ref{sec:bridge} mapping infections
forward to onsets through the multinomial split \eqref{eq:bridge_onsets}.  Here,
unlike the bridge model, the incubation weights are restricted to $a \geq 1$
(no lag-0 mass): as the causal-ordering remark below explains, at most one of the
incubation and TOST distributions may place mass at lag~0, and here it is the
TOST.  In
